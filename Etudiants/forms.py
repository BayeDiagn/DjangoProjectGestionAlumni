...
class EtudiantForm(UserCreationForm):
   # password1 = forms.CharField(
    ...
    class Meta:    #class Meta(UserCreationForm.Meta):
        model=Etudiant
        fields=["first_name","last_name","code_permenant","email","adresse","tel","password1","password2","photo","couverture","about","profession","cv"]
...
class EtudiantFormUpdate(forms.ModelForm):
      class Meta:    #class Meta(UserCreationForm.Meta):
            model=Etudiant
            fields=["first_name","last_name","code_permenant","email","adresse","tel","photo","couverture","about","profession","cv"]
